...
const slots = [
    ...
    {
        label: 'homepage hero',
        url: `${WP}/2025/12/SRO_0237-scaled.jpg`,
        doc: 'homepage',
        kind: 'single',
        field: 'heroImage',
    },
    {
        label: 'story vintage (left)',
        url: `${WP}/2021/11/Holiday-River-Rafting-vintage.jpg`,
        doc: 'homepage',
        kind: 'single',
        field: 'storyImageLeft',
    },
    {
        label: 'story Dee portrait',
        url: `${WP}/2021/11/Dee-Holladay-portrait.jpg`,
        doc: 'homepage',
        kind: 'single',
        field: 'storyImagePortrait',
    },
    {
        label: 'learn: river cooking',
        url: `${WP}/2025/11/river-cooking.jpg`,
        doc: 'homepage',
        kind: 'learn',
        key: 'learn-0',
    },
    {
        label: 'learn: triple rig',
        url: `${WP}/2025/11/triple-rig-history.jpg`,
        doc: 'homepage',
        kind: 'learn',
        key: 'learn-1',
    },
    {
        label: 'learn: packing',
        url: `${WP}/2025/11/packing-for-trip.jpg`,
        doc: 'homepage',
        kind: 'learn',
        key: 'learn-2',
    },
    {
        label: 'learn: stargazing',
        url: `${WP}/2025/11/stargazing-on-river.jpg`,
        doc: 'homepage',
        kind: 'learn',
        key: 'learn-3',
    },
    ...
    {
        label: 'trip: cataract',
        url: `${WP}/2025/11/Cataract-Canyon-Rafting-Trips-4.jpg`,
        doc: 'trip-cataract-canyon',
        kind: 'photos',
        alt: 'Rafts running Cataract Canyon whitewater',
    },
    {
        label: 'trip: westwater',
        url: `${WP}/2025/11/Westwater-Canyon-Rafting-Trips.jpg`,
        doc: 'trip-westwater-canyon',
        kind: 'photos',
        alt: 'Rafting Westwater Canyon',
    },
    {
        label: 'trip: the maze',
        url: `${WP}/2025/11/The-Maze-Canyonlands.jpg`,
        doc: 'trip-the-maze',
        kind: 'photos',
        alt: 'Mountain biking the Maze district, Canyonlands',
    },
    {
        label: 'trip: lodore',
        url: `${WP}/2025/11/Gates-of-Lodore-Rafting.jpg`,
        doc: 'trip-gates-of-lodore',
        kind: 'photos',
        alt: 'Rafting the Gates of Lodore',
    },
    {
        label: 'trip: desolation bluegrass',
        url: `${WP}/2025/11/Desolation-Canyon-Rafting-Trip-3-1.jpg`,
        doc: 'trip-desolation-canyon-bluegrass',
        kind: 'photos',
        alt: 'Rafts in Desolation Canyon',
    },
    {
        label: 'trip: yampa',
        url: `${WP}/2025/10/Yampa-River-Rafting-Tiger-Wall.jpg`,
        doc: 'trip-yampa',
        kind: 'photos',
        alt: 'Yampa River at Tiger Wall',
    },

    // Rivers (image)
    {
        label: 'river: desolation',
        url: `${WP}/2025/11/Desolation-Canyon-Rafting-Trip-3-1.jpg`,
        doc: 'river-desolation',
        kind: 'single',
        field: 'image',
    },
    {
    ...
    },
    {
        label: 'river: lodore',
        url: `${WP}/2025/11/Gates-of-Lodore-Rafting.jpg`,
        doc: 'river-gates-of-lodore',
        kind: 'single',
        field: 'image',
    },
    {
        label: 'river: westwater',
        url: `${WP}/2025/11/Westwater-Canyon-Rafting-Trips.jpg`,
        doc: 'river-westwater',
        kind: 'single',
        field: 'image',
    ...
    {
        label: 'river: cataract',
        url: `${WP}/2025/11/Cataract-Canyon-whitewater-rafting.png`,
        doc: 'river-cataract',
        kind: 'single',
        field: 'image',
    },
    {
        label: 'river: san juan',
        url: `${WP}/2025/11/San-Juan-River-Banner-1.png`,
        doc: 'river-san-juan',
        kind: 'single',
        field: 'image',
    },
    {
        label: 'river: white rim',
        url: `${WP}/2025/11/White-Rim-Mountain-Biking.jpg`,
        doc: 'river-white-rim',
        kind: 'single',
        field: 'image',
    },
    ...
    {
        label: 'river: san rafael',
        url: `${WP}/2025/11/San-Rafael-Swell.jpg`,
        doc: 'river-san-rafael',
        kind: 'single',
        field: 'image',
    },
];
